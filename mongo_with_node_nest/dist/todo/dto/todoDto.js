...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The ID of the todo item', example: '12345' }),
    __metadata("design:type", String)
], UpdateTodoDto.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The new title of the todo item', example: 'Updated Title' }),
    __metadata("design:type", String)
